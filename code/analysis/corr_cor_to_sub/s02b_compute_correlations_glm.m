% analyses/corr_cor_to_sub/s03b_compute_correlations_glm.m
%
...
for subj=1:8 
	...
	for hemi=1:2
        ...
        fprintf(['Subj: ' num2str(subj) ', Hemi: ' num2str(hemi) '\n']);
        ...
        for idx_beta = 1:15
            ...
            nsd_savenifti(vol, [1, 1, 1], [data_dir 'subj0' num2str(subj) '/mni/corr_cor_to_sub_hemi_' num2str(hemi) '_method_1_glm_beta=' num2str(idx_beta) '.nii.gz'], 1, [92, 127, 73]);
        end
        ...
        for idx_beta = 1:15
            ...
            % Save to disk as nifti 
            nsd_savenifti(vol, [1, 1, 1], [data_dir 'subj0' num2str(subj) '/mni/corr_cor_to_sub_hemi_' num2str(hemi) '_method_2_glm_beta=' num2str(idx_beta) '.nii.gz'], 1, [92, 127, 73]);
		end
	end
end
