...
s1 = load(sprintf('~/ext/figurefiles/nsd/stim%s_p%d_q%d_versionA.mat','prf',1,1));
s2 = load(sprintf('~/ext/figurefiles/nsd/stim%s_p%d_q%d_versionA.mat','prf',5,1));
stim = s1.stim + s2.stim;
stim(stim>1) = 1;
save(sprintf('~/ext/figurefiles/nsd/stim%s_p%d_q%d_versionA.mat','prf',15,1),'stim','-v7.3','-nocompression');
